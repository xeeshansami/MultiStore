...
public class AccountFragment extends Fragment implements AccountView, AppSettingsInteractor.CallBack {
    ...
    private RelativeLayout wishlist, purchase_history, my_bids, account_info, logout;
...
//        my_bids = v.findViewById(R.id.my_bids);
//        my_bids.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if(authResponse != null && authResponse.getUser() != null){
//                    startActivity(new Intent(getContext(), MyBidsActivity.class));
//                }
//                else {
//                    startActivityForResult(new Intent(getActivity(), LoginActivity.class), 100);
//                }
...
//        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(authResponse != null && authResponse.getUser() != null){
                    new AccountPresenter(ThreadExecutor.getInstance(), MainThreadImpl.getInstance(), AccountFragment.this).performLogout(authResponse.getAccessToken());
                }
            }
        });
    }
